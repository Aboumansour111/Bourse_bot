...
STOP_ATR = float(__import__("os").environ.get("STOP_ATR", "1.5"))
TARGET_ATR = float(__import__("os").environ.get("TARGET_ATR", "3.0"))
        ...
        for i in range(
            ...
            for j in range(
                ...
                if signal_j is not None:
                    ...
                    if ema20_values and ema50_values:
                        ema20_j = ema20_values[-1]
                        ema50_j = ema50_values[-1]
